  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        addTeamHeaderBg: "url('/assets/images/addTeamHeaderBg.svg')",
        bottom_right: "url('/assets/images/bg_bottom_right.svg')",
      },
      boxShadow: {
        ...
        db: "-3px 4px 4px -3px #0000001A",
        employee: "0px 4px 6px 2px #BBAACC26;",
      },
    },
